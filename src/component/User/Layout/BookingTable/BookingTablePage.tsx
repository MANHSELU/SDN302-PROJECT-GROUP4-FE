...
export default function BookingTablePage() {
  ...
  // tổng tiền
  const totalPrice = (selectedTable?.price || 0) * (selectedSlots.length || 0);
    ...
    >
      ...
      <div className="relative w-full max-w-4xl bg-white/10 rounded-2xl p-8 text-white shadow-2xl">
        ...
        <div className="flex gap-6">
          ...
          <button
            className="flex-1 bg-green-600 hover:bg-green-700 text-white font-semibold py-3 rounded-lg shadow-md transition duration-300"
            onClick={DatLich}
          >
            Đặt lịch
          </button>

                ...
                <div className="col-span-12 lg:col-span-8 space-y-8 px-4">
                            ...
                            <div className="image-container flex gap-4">
                                ...
                                {listBook.map((book, i) => (
                                    ...
                                    >
                                        ...
                                        <div className="flex justify-between items-start" style={{ width: "150px" }}>
                                        ...
                                        <p className="text-[10px] text-gray-400 text-right" style={{ paddingRight: "10px", paddingTop: "3px" }}>readings</p>

                                        {/* Tác giả + Lượt đọc */}
                                        <div className="flex justify-between items-center mt-2 mx-4">
                                            <p className="text-[10px] text-gray-400">{book?.authors?.name || "không rõ tác giả "}</p>
                 ...
                 transform transition duration-300 hover:scale-110"
                                >
                                    ...
                                    />
                                    <div className="flex justify-between items-start mt-2 px-2" style={{ width: "150px" }}>
                                    ...
                                    <div className="flex justify-between items-center mt-2 mx-4 mb-2">
                                        <p className="text-[10px] text-gray-400">{books?.authors?.name || "không rõ tác giả "}</p>
                                        <p className="text-yellow-400 font-bold text-xs">1.2+</p>
                                    </div>
                                </div>
                            ))}
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center max-w-6xl mx-auto">
                    ...
                    <div className="p-8 md:p-10 rounded-2xl shadow-lg border border-gray-200 bg-white">
                        ...
                        <p className="text-gray-700 leading-relaxed text-lg">
                            Chúng tôi hiểu cảm giác bối rối khi đứng trước hàng ngàn cuốn sách mà
                            không biết nên bắt đầu từ đâu. <br /><br />
                            Chúng tôi từng tìm kiếm những cuốn sách phù hợp với sở thích, mục tiêu
                            học tập hay đơn giản chỉ để thư giãn, nhưng lại bỏ cuộc vì thiếu gợi ý rõ ràng
                            hoặc không gian đọc chưa thật sự thoải mái. <br /><br />
                            <span className="font-medium text-gray-900 italic">
                                "Tại sao không có một thư viện vừa hiện đại, thân thiện, vừa mang đến
                                trải nghiệm cá nhân hóa cho mỗi độc giả?"
                            </span>
                        </p>
                    </div>
            ...
            <section className="mt-10 px-6 py-12 bg-slate-900">
                ...
                <div className="max-w-4xl mx-auto text-center mb-12">
                    <h2 className="text-2xl md:text-3xl font-bold italic text-slate-100">
                        “Một thư viện không chỉ cho bạn sách, mà còn mở ra cả thế giới trong tâm trí bạn.”
                    </h2>
                        ...
                        <div className="flex items-center justify-center md:justify-start mt-3">
                            {[...Array(5)].map((_, i) => (
                                <Star
                                    key={i}
                                    size={28}
                                    className={`${i < 4 ? "fill-green-400 text-green-400" : "text-slate-600"
                                        }`}
                                />
                            ))}
                    ...
                    <div className="flex-1 w-full space-y-4">
                        {ratings.map((r) => (
                            <div key={r.stars} className="flex items-center gap-5">
                                ...
                                <span className="w-14 text-base text-slate-300">{r.percent}%</span>
